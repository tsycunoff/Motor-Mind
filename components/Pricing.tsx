                    ...
                    {billingCycle === 'yearly' && (
                      <div className="mt-2">
                        <span className="text-sm text-green-600 font-medium">
                          Экономия {((plan.price.monthly * 12 - plan.price.yearly) / 1000).toFixed(0)}К₽ в год
                        </span>
                      </div>
                    )}
                    ...
                    {billingCycle === 'monthly' && (
                      <div className="mt-2">
                        <span className="text-sm text-slate-500">
                          При годовой оплате: {plan.price.yearly.toLocaleString()}₽/год
                        </span>
                      </div>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.5V12m-9.5-9.5l9.5 9.5M12 21.5V12m9.5 9.5l-9.5-9.5" />
                </svg>
              </div>
